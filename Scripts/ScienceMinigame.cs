...
public class ScienceMinigame : MonoBehaviour
{
    ...
    public Button q3NxtBtn, q5NxtBtn, q6NxtBtn, q7NxtBtn, q10NxtBtn;
    ...
    public TMP_Dropdown[] Q3dropdowns, Q5dropdowns, Q6dropdowns, Q7dropdowns, Q10dropdowns;
    ...
    public int[] correctAnswersForQ3, correctAnswersForQ5, correctAnswersForQ6, correctAnswersForQ7, correctAnswersForQ10;
    ...
    void Start()
    {
        ...
        //Question 3
        foreach (TMP_Dropdown dropdown in Q3dropdowns)
        {
            dropdown.onValueChanged.AddListener(delegate { CheckDropdownValues(Q3dropdowns, correctAnswersForQ3, q3NxtBtn); });
        }
        // Initial checks for this set of dropdowns
        CheckDropdownValues(Q3dropdowns, correctAnswersForQ3, q3NxtBtn);

        //Question 5
        foreach (TMP_Dropdown dropdown in Q5dropdowns)
        {
            dropdown.onValueChanged.AddListener(delegate { CheckDropdownValues(Q5dropdowns, correctAnswersForQ5, q5NxtBtn); });
        }
        // Initial checks for this set of dropdowns
        CheckDropdownValues(Q5dropdowns, correctAnswersForQ5, q5NxtBtn);

        //Question 6
        foreach (TMP_Dropdown dropdown in Q6dropdowns)
        {
            dropdown.onValueChanged.AddListener(delegate { CheckDropdownValues(Q6dropdowns, correctAnswersForQ6, q6NxtBtn); });
        }
        // Initial checks for this set of dropdowns
        CheckDropdownValues(Q6dropdowns, correctAnswersForQ6, q6NxtBtn);

        //Question 7
        foreach (TMP_Dropdown dropdown in Q7dropdowns)
        {
            dropdown.onValueChanged.AddListener(delegate { CheckDropdownValues(Q7dropdowns, correctAnswersForQ7, q7NxtBtn); });
        }
        // Initial checks for this set of dropdowns
        CheckDropdownValues(Q7dropdowns, correctAnswersForQ7, q7NxtBtn);

        //Question 10
        foreach (TMP_Dropdown dropdown in Q10dropdowns)
        {
            dropdown.onValueChanged.AddListener(delegate { CheckDropdownValues(Q10dropdowns, correctAnswersForQ10, q10NxtBtn); });
        }
        // Initial checks for this set of dropdowns
        CheckDropdownValues(Q10dropdowns, correctAnswersForQ10, q10NxtBtn);
    ...
    void Update()
    {
        ...
        if (beginParent.activeInHierarchy || questions[3].activeInHierarchy || questions[7].activeInHierarchy || questions[11].activeInHierarchy || questions[13].activeInHierarchy)
        {
